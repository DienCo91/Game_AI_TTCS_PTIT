...
public class GameManager1 : MonoBehaviour {
    ...
    public void Accept()
    {
        ...
        var type 
            = (IsFinished) 
            ? UIManager1.ResolutionScreenType.Finish 
            : (isCorrect) ? UIManager1.ResolutionScreenType.Correct 
            : UIManager1.ResolutionScreenType.Incorrect;

        events.DisplayResolutionScreen?.Invoke(type, data.Questions[currentQuestion].AddScore);

        AudioManager.Instance.PlaySound((isCorrect) ? "CorrectSFX" : "IncorrectSFX");

        if (type != UIManager1.ResolutionScreenType.Finish)
        {
    ...
    void LoadData()
    {
        // var path = "C:\\Users\\Nhat_Minh\\Downloads\\Chess\\Assets\\Quizz\\Assets\\Q1.xml";
        var path = "C:\\Users\\Nhat_Minh\\Downloads\\Chess\\Assets\\Quizz\\Assets\\Q" + events.level + ".xml";
        Debug.Log("path"+path);
    ...
    int GetRandomQuestionIndex()
    {
        ...
        // Debug.Log(FinishedQuestions.Count +" "+ data.Questions.Length);
